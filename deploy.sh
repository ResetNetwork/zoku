...
echo "   npx wrangler domains add zoku.yourdomain.com"
echo ""
echo "2. Customize branding (optional):"
echo "   echo 'VITE_APP_NAME=Your Organization' > frontend/.env"
echo "   cd frontend && npm run build && cd .."
echo "   npx wrangler deploy"
echo ""
echo "3. Setup Cloudflare Access (required for web UI):"
echo "   npx wrangler open"
echo "   → Navigate to: Zero Trust → Access → Applications"
echo "   → Add application for: zoku.yourdomain.com"
echo "   → Allow emails: @yourdomain.com or specific users"
echo ""
...
echo ""
echo "5. Login and verify admin access:"
